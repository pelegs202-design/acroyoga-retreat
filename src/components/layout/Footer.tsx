...
/**
 * Footer — Brutalist footer per stitch-screens/header-footer.html design spec.
 *
 * Features:
 * - #0a0a0a background with pink top border accent
 * - Brand wordmark: pink square dot + Acro (white) + Havura (pink)
 * - Tagline + social links
 * - Platform nav links with magnetic hover on desktop
 * - Copyright + legal links
 * - RTL-safe via CSS logical properties
 *
 * @see stitch-screens/header-footer.html — footer design spec
 */
export default function Footer() {
  ...
  return (
    <footer className="border-t border-brand/20 bg-[#0a0a0a] px-4 pb-10 pt-16 sm:px-8 lg:px-[8vw]">

      {/* Main grid: brand | platform | community | legal */}
      <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] mb-16">

        {/* Brand column */}
        <div>
          <Link
            href="/"
            className="mb-4 flex items-center gap-2 font-black tracking-tighter no-underline"
            aria-label="AcroHavura"
          >
