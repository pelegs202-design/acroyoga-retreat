...
/**
 * City hero section — server component.
    ...
    <section className="relative overflow-hidden rounded-none border-4 border-neutral-100 bg-neutral-950 px-8 py-16 text-center sm:px-12 sm:py-24">
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <Link
            href={`/${locale}/quiz`}
            className="inline-block border-4 border-neutral-100 bg-brand px-8 py-4 text-lg font-black uppercase tracking-widest text-neutral-950 transition-all hover:bg-neutral-100 hover:text-neutral-950"
          >
            {t(`${cityKey}.heroCta`)}
          </Link>
          <Link
            href={`/${locale}/jams`}
            className="inline-block border-4 border-neutral-100 bg-transparent px-8 py-4 text-lg font-black uppercase tracking-widest text-neutral-100 transition-all hover:bg-neutral-100 hover:text-neutral-950"
          >
